package com.krews.plugin.customwired.pluswired.triggers;
...
public class PlusWiredTriggerWalksOnFurni extends InteractionWiredTrigger
{
    ...
    public PlusWiredTriggerWalksOnFurni(ResultSet set, Item baseItem) throws SQLException
    {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public PlusWiredTriggerWalksOnFurni(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells)
    {
