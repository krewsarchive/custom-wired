package com.krews.plugin.customwired.pluswired.effects;
...
import com.krews.plugin.customwired.pluswired.WiredMatchFurniSetting;
...
public class PlusWiredEffectMatchFurniStatePosition extends InteractionWiredEffect
{
    ...
    public PlusWiredEffectMatchFurniStatePosition(ResultSet set, Item baseItem) throws SQLException
    {
        super(set, baseItem);
        this.settings = new THashSet<>(0);
    }

    public PlusWiredEffectMatchFurniStatePosition(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells)
    {
    ...
    public void loadWiredData(ResultSet set, Room room) throws SQLException
    {
        ...
        for(int i = 0; i < items.length; i++)
        {
            try
            {
                ...
                if (stuff.length >= 7)
                {
                    this.settings.add(new WiredMatchFurniSetting(Integer.valueOf(stuff[0]), stuff[1], Integer.valueOf(stuff[2]), Integer.valueOf(stuff[3]), Integer.valueOf(stuff[4]), Double.parseDouble(stuff[5] +"-"+ stuff[6])));
                }
                else if (stuff.length >= 6)
                {
                    this.settings.add(new WiredMatchFurniSetting(Integer.valueOf(stuff[0]), stuff[1], Integer.valueOf(stuff[2]), Integer.valueOf(stuff[3]), Integer.valueOf(stuff[4]), Double.parseDouble(stuff[5])));
                }
